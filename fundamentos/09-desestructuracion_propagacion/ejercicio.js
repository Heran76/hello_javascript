...
let person = { alias: "HeranDev", age: 48, job: "Programador" }
let { alias, age } = person
console.log(alias)
console.log(age)

// 4. Usa desestructuración para extraer dos propiedades de un objeto y asi­gnalas a nuevas variables con nombres diferentes.
...
let user = {
    username: "Herandev",
    details: {
        email: "heran@herandev.com",
        address: "Calle herandev"
    }
}
