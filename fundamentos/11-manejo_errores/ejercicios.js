...
// 9. Crea una función que verifique si un objeto tiene una propiedad especí­fica y lance una excepción personalizada.
...
function unstableOperation() {
    if (Math.random() > 0.9) { // Genera un número aleatorio entre 0 y 1 (Si no conoces "Math", el curso tiene una lecciÃ³n sobre mÃ³dulos)
